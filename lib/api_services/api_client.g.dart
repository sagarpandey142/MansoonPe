...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<AllOrdersRes> getOrdersById(
    String endpoint,
    dynamic kr,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  Future<ContPayRes> payAmount(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(kr.toJson());
    final _options = _setStreamType<ContPayRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'api/contractor-payment/${endpoint}/payment',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ContPayRes _value;
    try {
      _value = ContPayRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CreditRes> getAllCredits(dynamic kr) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = kr;
    final _options = _setStreamType<CreditRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreditRes _value;
    try {
      _value = CreditRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
