  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx((){
          return
            controller.project.value.id !=  null  ?
            Column(
            children: [
              // Header
             Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        String status =
                        controller.project.value.status.toString().toLowerCase();
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Total Purchases: ${controller.project.value.budget}",
                              style: TextStyle(
                        ...
                        children: [
                          Text.rich(
                            TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: HomePageController.formatDate(controller.project.value.createdOn!),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color(
                                controller.project.value.status == "IN_REVIEW"
                                    ? 0xFFFFFAEB // Even lighter orange
                                    : controller.project.value.status == "ACTIVE"
